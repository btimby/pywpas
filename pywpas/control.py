...
# HS20_GET_NAI_HOME_REALM_LIST HS20_ICON_REQUEST IBSS_RSN INTERWORKING_ADD_NETWORK
# INTERWORKING_CONNECT INTERWORKING_SELECT LIST_NETWORKS LOG_LEVEL
# MAC_RAND_SCAN MESH_GROUP_ADD MESH_GROUP_REMOVE MESH_INTERFACE_ADD MGMT_TX
# NEIGHBOR_REP_REQUEST NFC_GET_HANDOVER_REQ NFC_GET_HANDOVER_SEL
# NFC_REPORT_HANDOVER NOTE P2P_ASP_PROVISION P2P_ASP_PROVISION_RESP P2P_CONNECT
# P2P_EXT_LISTEN P2P_FIND P2P_GROUP_ADD P2P_GROUP_REMOVE P2P_INVITE
# P2P_LISTEN P2P_PEER P2P_PRESENCE_REQ P2P_PROV_DISC P2P_REJECT
# P2P_REMOVE_CLIENT P2P_SERV_DISC_CANCEL_REQ P2P_SERV_DISC_EXTERNAL
# P2P_SERV_DISC_REQ P2P_SERV_DISC_RESP P2P_SERVICE_ADD P2P_SERVICE_DEL
# P2P_SERVICE_REP P2P_SET P2P_UNAUTHORIZE PKTCNT_POLL PREAUTH RADIO_WORK
# RELOG REMOVE_CRED REMOVE_NETWORK ROAM SCAN SCAN_INTERVAL SELECT_NETWORK
# SET SET_CRED SET_NETWORK SIGNAL_POLL STA STA_AUTOCONNECT STA-NEXT STATUS
# STKSTART TDLS_CANCEL_CHAN_SWITCH TDLS_CHAN_SWITCH TDLS_DISCOVER
# TDLS_LINK_STATUS TDLS_SETUP TDLS_TEARDOWN TEST_ALLOC_FAIL TEST_FAIL
# VENDOR VENDOR_ELEM_ADD VENDOR_ELEM_GET VENDOR_ELEM_REMOVE WFD_SUBELEM_GET
# WFD_SUBELEM_SET WMM_AC_ADDTS WMM_AC_DELTS WNM_BSS_QUERY WNM_SLEEP
# WPA_CTRL_RSP WPS_AP_PIN WPS_CHECK_PIN WPS_ER_CONFIG WPS_ER_LEARN
# WPS_ER_NFC_CONFIG_TOKEN WPS_ER_PBC WPS_ER_PIN WPS_ER_SET_CONFIG
# WPS_ER_START WPS_NFC WPS_NFC_CONFIG_TOKEN WPS_NFC_TAG_READ
# WPS_NFC_TOKEN WPS_PBC WPS_PIN WPS_REG
#
